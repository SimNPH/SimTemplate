...
# load parameters
design <- read.table("parameters/parameters_progression_os.csv", sep=",", dec=".", header=TRUE)
...
save_folder <- paste0("results/progression_", Sys.info()["nodename"], "_", strftime(Sys.time(), "%Y-%m-%d_%H%M%S"))
