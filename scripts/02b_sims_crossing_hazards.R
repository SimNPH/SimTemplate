...
# load parameters
design <- read.table("parameters/parameters_crossing_hazards.csv", sep=",", dec=".", header=TRUE)
...
save_folder <- paste0("results/crossing_hazards_", Sys.info()["nodename"], "_", strftime(Sys.time(), "%Y-%m-%d_%H%M%S"))
