...
# load parameters
design <- read.table("parameters/parameters_subgroup.csv", sep=",", dec=".", header=TRUE)
...
save_folder <- paste0("results/subgroup_", Sys.info()["nodename"], "_", strftime(Sys.time(), "%Y-%m-%d_%H%M%S"))
